<template>
    <DocComponent title="Vue Tabs Component" header="Tabs" description="Tabs is a container component to group content with tabs." :componentDocs="docs" :apiDocs="['Tab', 'TabPanel']" :ptTabComponent="ptComponent" :themingDocs="themingDoc" />
</template>
