<template>
    <DocSectionText v-bind="$attrs">
        <p>
            The <a href="https://github.com/unplugin/unplugin-vue-components" target="_blank" rel="noopener noreferrer">unplugin-vue-components</a> library can automatically import and register CoscomUI components with the built-in resolver. Let's
            begin with installing the library.
        </p>
        <DocSectionCode :code="code1" hideToggleCode importCode hideStackBlitz />
        <p>Next step would be adding the <i>CoscomUIResolver</i> at vite.config using the <i>Components</i> plugin.</p>
...
import {CoscomUIResolver} from 'unplugin-vue-components/resolvers';
