<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>
            The style classes of CoscomUI are defined under the <i>primevue</i> CSS layer to be easier to customize by having low specificity. If you are using a CSS library that styles default HTML elements such as Tailwind Preflight, Bootstrap,
    ...
    data() {
        return {
            code1: {
                basic: `
<script>
import '@coscom/coscom-ui/resources/themes/aura-light-green/theme.css'
<\/script>
`
            },
            code2: {
...
export default defineNuxtConfig({
    ...
    css: ['@coscom/coscom-ui/resources/themes/aura-light-green/theme.css']
})
`
            },
            code4: {
