<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>
            ...
            layers, we'd have to write a stronger css or use <i>!important</i> however, with layers, this does not present an issue as your CSS can always override CoscomUI with a more straightforward class name such as <i>my-switch-slider</i>.
