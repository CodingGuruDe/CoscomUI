<template>
    ...
    <div class="card dock-demo">
        ...
        <Menubar :model="menubarItems">
            <template #start>
                <i class="cs el-apple px-2"></i>
            </template>
            <template #end>
                <i class="cs el-video px-2" />
                <i class="cs el-wifi px-2" />
                <i class="cs el-volume-up px-2" />
                <span class="px-2">Fri 13:07</span>
                <i class="cs el-search px-2" />
                <i class="cs el-bars px-2" />
            </template>
        </Menubar>
        ...
        <div class="dock-window dock-advanced">
            ...
            <Dialog v-model:visible="displayTerminal" header="Terminal" :breakpoints="{ '960px': '50vw' }" :style="{ width: '40vw' }" :maximizable="true">
                <Terminal welcomeMessage="Welcome to CoscomUI(cmd: 'date', 'greet {0}', 'random' and 'clear')" prompt="primevue $" />
            </Dialog>
