                ...
                <div class="border-1 surface-border border-round m-2 p-3">
                    <div class="mb-3">
                        <div class="relative mx-auto">
                            <img :src="'@/assets/images/product/' + slotProps.data.image" :alt="slotProps.data.name" class="w-full border-round" />
                    ...
                    <div class="flex justify-content-between align-items-center">
                        ...
                        <span>
                            <Button icon="cs el-heart" severity="secondary" outlined />
                            <Button icon="cs el-shopping-cart" class="ml-2" />
                        </span>
                    </div>
                </div>
            </template>
