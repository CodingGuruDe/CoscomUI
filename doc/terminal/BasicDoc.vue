<template>
    ...
    <div class="card">
        ...
        <Terminal welcomeMessage="Welcome to CoscomUI" prompt="primevue $" aria-label="CoscomUI Terminal Service" />
    </div>
    ...
    data() {
        return {
            code: {
                basic: `
<Terminal
    welcomeMessage="Welcome to CoscomUI"
    prompt="primevue $"
    aria-label="CoscomUI Terminal Service"
/>
`,
                options: `
<template>
