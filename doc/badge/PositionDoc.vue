<template>
    ...
    <div class="card flex flex-wrap justify-content-center gap-4">
        <i v-badge="2" class="cs el-bell" style="font-size: 2rem" />
        <i v-badge.danger="'5+'" class="cs el-calendar" style="font-size: 2rem" />
        <i v-badge.danger class="cs el-envelope" style="font-size: 2rem" />
    </div>
