<template>
    ...
    <div class="card flex justify-content-center">
        <Button label="Select a Product" icon="cs el-search" @click="showProducts" />
...
<template>
	<div>
        <div class="flex justify-content-end mt-1 mb-3">
            <Button icon="cs el-external-link" label="Nested Dialog" outlined severity="success" @click="showInfo" />
        </div>
        <DataTable :value="products">
            ...
            <Column header="Image">
                <template #body="slotProps">
                    <img :src="'@/assets/images/product/' + slotProps.data.image" :alt="slotProps.data.name" class="w-4rem" />
                </template>
            </Column>
            ...
            <Column style="width:5rem">
                <template #body="slotProps">
                    <Button type="button" icon="cs el-plus" text rounded @click="selectProduct(slotProps.data)"></Button>
                </template>
            </Column>
		</DataTable>
...
<\/script>
                    ...
                    'src/components/FooterDemo.vue': {
                        content: `
<template>
    <Button type="button" label="Cancel" icon="cs el-times" @click="closeDialog({ buttonType: 'Cancel' })" autofocus></Button>
</template>
