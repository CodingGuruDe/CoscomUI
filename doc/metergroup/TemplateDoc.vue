...
export default {
    data() {
        return {
            value: [
                { label: 'Apps', color1: '#34d399', color2: '#fbbf24', value: 25, icon: 'cs el-table' },
                { label: 'Messages', color1: '#fbbf24', color2: '#60a5fa', value: 15, icon: 'cs el-inbox' },
                { label: 'Media', color1: '#60a5fa', color2: '#c084fc', value: 20, icon: 'cs el-image' },
                { label: 'System', color1: '#c084fc', color2: '#c084fc', value: 10, icon: 'cs el-cog' }
            ],
            code: {
                basic: `
<MeterGroup :value="value" labelPosition="start">
