<template>
    ...
    <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
        ...
        <div class="field">
            ...
            <small v-if="submitted && !product.name" class="v-error">Name is required.</small>
        </div>
        <div class="field">
        ...
        <template #footer>
            <Button label="Cancel" icon="cs el-times" text @click="hideDialog" />
            <Button label="Save" icon="cs el-check" text @click="saveProduct" />
        </template>
    </Dialog>
    ...
    <Dialog v-model:visible="deleteProductDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
        ...
        <template #footer>
            <Button label="No" icon="cs el-times" text @click="deleteProductDialog = false" />
            <Button label="Yes" icon="cs el-check" text @click="deleteProduct" />
        </template>
    </Dialog>
    ...
    <Dialog v-model:visible="deleteProductsDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
        ...
        <template #footer>
            <Button label="No" icon="cs el-times" text @click="deleteProductsDialog = false" />
            <Button label="Yes" icon="cs el-check" text @click="deleteSelectedProducts" />
        </template>
    </Dialog>
    ...
    <div>
        ...
        <Dialog v-model:visible="productDialog" :style="{width: '450px'}" header="Product Details" :modal="true" class="p-fluid">
            ...
            <div class="field">
                <label for="name">Name</label>
                <InputText id="name" v-model.trim="product.name" required="true" autofocus :invalid="submitted && !product.name" />
                <small class="v-error" v-if="submitted && !product.name">Name is required.</small>
            </div>
            <div class="field">
                <label for="description">Description</label>
                <Textarea id="description" v-model="product.description" required="true" rows="3" cols="20" />
