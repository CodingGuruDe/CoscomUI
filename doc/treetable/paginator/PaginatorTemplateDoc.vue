<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <NuxtLink to="/paginator">Paginator</NuxtLink> component for more information about the advanced customization options.
        </p>
    </DocSectionText>
        ...
        <div class="card">
            ...
            >
                <template #paginatorstart>
                    <Button type="button" icon="cs el-refresh" text />
                </template>
                <Column field="name" header="Name" expander></Column>
                <Column field="size" header="Size"></Column>
                <Column field="type" header="Type"></Column>
                <template #paginatorend>
                    <Button type="button" icon="cs el-download" text />
                </template>
            </TreeTable>
        </div>
    </DeferredDemo>
