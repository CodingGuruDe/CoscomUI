                ...
                <Column headerStyle="width: 10rem">
                    <template #body>
                        <div class="flex flex-wrap gap-2">
                            <Button type="button" icon="cs el-search" rounded />
                            <Button type="button" icon="cs el-pencil" rounded severity="success" />
                        </div>
                    </template>
                </Column>
                <template #footer>
                    <div class="flex justify-content-start">
                        <Button icon="cs el-refresh" label="Reload" severity="warning" />
                    </div>
                </template>
            </TreeTable>
        </div>
