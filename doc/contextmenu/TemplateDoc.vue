        ...
        <ul class="m-0 p-0 list-none border-1 surface-border border-round p-3 flex flex-column gap-2 w-full md:w-30rem">
            ...
            >
                <div class="flex flex-wrap p-2 align-items-center gap-3">
                    <img class="w-4rem flex-shrink-0 border-round" :src="'@/assets/images/product/' + product.image" :alt="product.name" />
                    <div class="flex-1 flex flex-column gap-1">
                        <span class="font-bold">{{ product.name }}</span>
                        <div class="flex align-items-center gap-2">
                            <i class="cs el-tag text-sm"></i>
        ...
        <ContextMenu ref="menu" :model="items" @hide="selectedId = null">
            <template #item="{ item, props }">
                <a v-ripple class="flex align-items-center" v-bind="props.action">
                    ...
                    <i v-if="item.items" class="cs el-angle-right ml-auto"></i>
                </a>
            </template>
        </ContextMenu>
    </div>
