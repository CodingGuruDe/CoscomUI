<template>
    ...
    <div class="card">
        <div class="flex gap-2 justify-content-center">
            <Button icon="cs el-arrow-right" @click="visibleLeft = true" />
            <Button icon="cs el-arrow-left" @click="visibleRight = true" />
            <Button icon="cs el-arrow-down" @click="visibleTop = true" />
            <Button icon="cs el-arrow-up" @click="visibleBottom = true" />
        </div>
