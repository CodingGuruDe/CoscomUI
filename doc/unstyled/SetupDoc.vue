<template>
    <DocSectionText v-bind="$attrs">
        <p>Unstyled mode is enabled for the whole suite by setting <i>unstyled</i> as true during CoscomUI installation.</p>
        ...
        <div class="card flex justify-content-center">
            <Button label="Check" icon="cs el-check" unstyled />
        </div>
...
`
            ...
            code2: {
                basic: `
<Button label="Check" icon="cs el-check" unstyled></Button>
`
            }
        };
    }
