<template>
    ...
    <div class="card flex justify-content-center">
        <Button type="button" icon="cs el-share-alt" label="Share" @click="toggle" />
        ...
        <OverlayPanel ref="op">
            <div class="flex flex-column gap-3 w-25rem">
                <div>
                    ...
                    <InputGroup>
                        <InputText value="#" readonly class="w-25rem"></InputText>
                        <InputGroupAddon>
                ...
                <div>
                    ...
                    <InputGroup>
                        ...
                        <Button label="Invite" icon="cs el-users"></Button>
                    </InputGroup>
                </div>
                <div>
                    ...
                    <ul class="list-none p-0 m-0 flex flex-column gap-3">
                        <li v-for="member in members" :key="member.name" class="flex align-items-center gap-2">
                            <img :src="`@/assets/images/avatar/${member.image}`" style="width: 32px" />
                            <div>
...
export default {
    data() {
        return {
            ...
            code: {
                basic: `
<Button type="button" icon="cs el-image" label="Image" @click="toggle" />
