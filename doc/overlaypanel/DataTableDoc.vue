<template>
    ...
    <div class="card flex flex-column align-items-center gap-3">
        <Button type="button" icon="cs el-search" :label="selectedProduct ? selectedProduct.name : 'Select a Product'" @click="toggle" aria-haspopup="true" aria-controls="overlay_panel" />
