...
const STYLE_ALIAS = {
    ...
    '@coscom/coscom-ui/animateonscroll/style': path.resolve(__dirname, './components/lib/animateonscroll/style/AnimateOnScrollStyle.js'),
    '@coscom/coscom-ui/autocomplete/style': path.resolve(__dirname, './components/lib/autocomplete/style/AutoCompleteStyle.js'),
    '@coscom/coscom-ui/avatar/style': path.resolve(__dirname, './components/lib/avatar/style/AvatarStyle.js'),
    '@coscom/coscom-ui/avatargroup/style': path.resolve(__dirname, './components/lib/avatargroup/style/AvatarGroupStyle.js'),
    ...
    '@coscom/coscom-ui/blockui/style': path.resolve(__dirname, './components/lib/blockui/style/BlockUIStyle.js'),
    ...
    '@coscom/coscom-ui/deferredcontent/style': path.resolve(__dirname, './components/lib/deferredcontent/style/DeferredContentStyle.js'),
    ...
    '@coscom/coscom-ui/iconfield/style': path.resolve(__dirname, './components/lib/iconfield/style/IconFieldStyle.js'),
    '@coscom/coscom-ui/inlinemessage/style': path.resolve(__dirname, './components/lib/inlinemessage/style/InlineMessageStyle.js'),
    ...
    '@coscom/coscom-ui/listbox/style': path.resolve(__dirname, './components/lib/listbox/style/ListboxStyle.js'),
    ...
    '@coscom/coscom-ui/metergroup/style': path.resolve(__dirname, './components/lib/metergroup/style/MeterGroupStyle.js'),
    ...
    '@coscom/coscom-ui/rating/style': path.resolve(__dirname, './components/lib/rating/style/RatingStyle.js'),
    ...
    '@coscom/coscom-ui/selectbutton/style': path.resolve(__dirname, './components/lib/selectbutton/style/SelectButtonStyle.js'),
    ...
    '@coscom/coscom-ui/tabview/style': path.resolve(__dirname, './components/lib/tabview/style/TabViewStyle.js'),
    '@coscom/coscom-ui/tag/style': path.resolve(__dirname, './components/lib/tag/style/TagStyle.js'),
    '@coscom/coscom-ui/terminal/style': path.resolve(__dirname, './components/lib/terminal/style/TerminalStyle.js'),
    ...
    '@coscom/coscom-ui/togglebutton/style': path.resolve(__dirname, './components/lib/togglebutton/style/ToggleButtonStyle.js'),
