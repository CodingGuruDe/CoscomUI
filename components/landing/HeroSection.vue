        ...
        <div class="flex flex-wrap">
            <div class="w-full xl:w-6 flex flex-column justify-content-center lg:pr-8 align-items-center xl:align-items-stretch">
                <a
                    ...
                    >🎉 Introducing the Tailwind Presets <i class="cs el-arrow-right text-sm"></i
                ></a>
                ...
                <p class="section-detail xl:text-left text-center px-0 mt-0 mb-5">
                    Elevate your web applications with CoscomUI's comprehensive suite of customizable, feature-rich UI components. With Coscom UI, turning your development vision into reality has never been easier.
                </p>
                <div class="flex align-items-center gap-3">
                    <NuxtLink to="/setup" class="linkbox active font-semibold py-3 px-4">
                        <span>Get Started</span>
                        <i class="cs el-arrow-right ml-3"></i>
                    </NuxtLink>
                    <a href="https://github.com/primefaces/primevue" target="_blank" rel="noopener noreferrer" class="linkbox font-semibold py-3 px-4">
                        ...
                        <i class="cs el-star-fill ml-3 text-yellow-500"></i>
                    </a>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="flex flex-column w-6 gap-5 pl-3">
                        <div class="box p-4 fadein animation-duration-500">
                            ...
                            <Button label="Add to Cart" icon="cs el-shopping-cart" outlined class="w-full"></Button>
                        </div>
                        <div class="box p-4 fadein animation-duration-500">
                            <ul class="list-none p-0 m-0">
                                ...
                                <li class="flex">
                                    <a class="flex align-items-center p-3 border-round w-full hover:surface-hover transition-colors transition-duration-150 cursor-pointer" style="border-radius: '10px'">
                                        <i class="cs el-home text-xl mr-3"></i>
                                ...
                                <li class="flex">
                                    <a class="flex align-items-center p-3 border-round w-full hover:surface-hover transition-colors transition-duration-150 cursor-pointer" style="border-radius: '10px'">
                                        <i class="cs el-envelope text-xl mr-3"></i>
                                        <span class="flex flex-column">
