<template>
    <section class="landing-themes py-8">
        ...
        <p class="section-detail">Crafted on a design-agnostic infrastructure, choose from a vast amount of themes such as Material, Bootstrap, Tailwind or develop your own.</p>
            ...
            <div class="box overflow-hidden z-1 p-5 table-container">
                ...
                >
                    ...
                    <Column headerStyle="min-width: 4rem; text-align: center" bodyStyle="text-align: center; overflow: visible">
                        <template #body>
                            <Button type="button" icon="cs el-cog" text></Button>
                        </template>
                    </Column>
                </DataTable>
            </div>
