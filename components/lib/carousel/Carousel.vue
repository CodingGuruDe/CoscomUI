...
export default {
    ...
    methods: {
        ...
        createStyle() {
            if (!this.carouselStyle) {
                ...
                DomHandler.setAttribute(this.carouselStyle, 'nonce', this.$coscom?.config?.csp?.nonce);
        ...
        ariaSlideNumber(value) {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.slideNumber.replace(/{slideNumber}/g, value) : undefined;
        },
        ariaPageLabel(value) {
    ...
    computed: {
        ...
        ariaSlideLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.slide : undefined;
        },
        ariaPrevButtonLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.prevPageLabel : undefined;
        },
        ariaNextButtonLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.nextPageLabel : undefined;
        },
        attributeSelector() {
        ...
        emptyMessageText() {
            return this.$coscom.config?.locale?.emptyMessage || '';
        }
    },
    components: {
        ChevronRightIcon,
