...
import AngleDoubleDownIcon from '@coscom/coscom-ui/icons/angledoubledown';
import AngleDoubleLeftIcon from '@coscom/coscom-ui/icons/angledoubleleft';
import AngleDoubleRightIcon from '@coscom/coscom-ui/icons/angledoubleright';
import AngleDoubleUpIcon from '@coscom/coscom-ui/icons/angledoubleup';
import AngleDownIcon from '@coscom/coscom-ui/icons/angledown';
import AngleLeftIcon from '@coscom/coscom-ui/icons/angleleft';
import AngleRightIcon from '@coscom/coscom-ui/icons/angleright';
import AngleUpIcon from '@coscom/coscom-ui/icons/angleup';
import Ripple from '@coscom/coscom-ui/ripple';
import { DomHandler, ObjectUtils, UniqueComponentId } from '@coscom/coscom-ui/utils';
    ...
    methods: {
        ...
        createStyle() {
            if (!this.styleElement && !this.isUnstyled) {
                ...
                DomHandler.setAttribute(this.styleElement, 'nonce', this.$coscom?.config?.csp?.nonce);
...
`;
    ...
    computed: {
        ...
        moveUpAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveUp : undefined;
        },
        moveTopAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveTop : undefined;
        },
        moveDownAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveDown : undefined;
        },
        moveBottomAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveBottom : undefined;
        },
        moveToTargetAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveToTarget : undefined;
        },
        moveAllToTargetAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveAllToTarget : undefined;
        },
        moveToSourceAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveToSource : undefined;
        },
        moveAllToSourceAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.moveAllToSource : undefined;
        }
    },
    components: {
        PLButton: Button,
