<template>
    <Portal>
        <transition name="v-confirm-popup" @enter="onEnter" @after-enter="onAfterEnter" @leave="onLeave" @after-leave="onAfterLeave" v-bind="ptm('transition')">
...
import { ConnectedOverlayScrollHandler, DomHandler, ZIndexUtils } from '@coscom/coscom-ui/utils';
...
export default {
    ...
    methods: {
        ...
        alignOverlay() {
            ...
            if (containerOffset.top < targetOffset.top) {
                this.container.setAttribute('data-v-confirm-popup-flipped', 'true');
                !this.isUnstyled && DomHandler.addClass(this.container, 'v-confirm-popup-flipped');
            }
        },
    ...
    computed: {
        ...
        acceptLabel() {
            return this.confirmation ? this.confirmation.acceptLabel || this.$coscom.config.locale.accept : null;
        },
        rejectLabel() {
            return this.confirmation ? this.confirmation.rejectLabel || this.$coscom.config.locale.reject : null;
        },
        acceptIcon() {
