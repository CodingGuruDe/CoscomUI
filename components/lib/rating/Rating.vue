...
<script>
import BanIcon from '@coscom/coscom-ui/icons/ban';
import StarIcon from '@coscom/coscom-ui/icons/star';
import StarFillIcon from '@coscom/coscom-ui/icons/starfill';
...
export default {
    ...
    methods: {
        ...
        starAriaLabel(value) {
            return value === 1 ? this.$coscom.config.locale.aria.star : this.$coscom.config.locale.aria.stars.replace(/{star}/g, value);
        }
    },
    components: {
