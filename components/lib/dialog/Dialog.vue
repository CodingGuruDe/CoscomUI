...
import WindowMaximizeIcon from '@coscom/coscom-ui/icons/windowmaximize';
import WindowMinimizeIcon from '@coscom/coscom-ui/icons/windowminimize';
import Portal from '@coscom/coscom-ui/portal';
import Ripple from '@coscom/coscom-ui/ripple';
import { DomHandler, UniqueComponentId, ZIndexUtils } from '@coscom/coscom-ui/utils';
...
export default {
    ...
    methods: {
        ...
        onEnter() {
            ...
            if (this.autoZIndex) {
                ZIndexUtils.set('modal', this.mask, this.baseZIndex + this.$coscom.config.zIndex.modal);
            }
        },
        onBeforeLeave() {
            if (this.modal) {
