...
export default {
    ...
    beforeCreate() {
        ...
        const originalValueInConfig = _useptInConfig ? this.$coscom?.config?.pt?.originalValue : undefined;
        const valueInConfig = _useptInConfig ? this.$coscom?.config?.pt?.value : this.$coscom?.config?.pt;
