<template>
    <div :class="cx('root')" :style="sx('root')" v-bind="ptmi('root')">
        ...
        <span class="v-hidden-accessible" aria-live="polite" v-bind="ptm('hiddenAccesible')" :data-v-hidden-accessible="true">
            {{ infoText }}
        </span>
...
import EyeSlashIcon from '@coscom/coscom-ui/icons/eyeslash';
...
export default {
    ...
    computed: {
        ...
        weakText() {
            return this.weakLabel || this.$coscom.config.locale.weak;
        },
        mediumText() {
            return this.mediumLabel || this.$coscom.config.locale.medium;
        },
        strongText() {
            return this.strongLabel || this.$coscom.config.locale.strong;
        },
        promptText() {
            return this.promptLabel || this.$coscom.config.locale.passwordPrompt;
        },
        panelUniqueId() {
