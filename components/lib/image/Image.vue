...
import EyeIcon from '@coscom/coscom-ui/icons/eye';
import RefreshIcon from '@coscom/coscom-ui/icons/refresh';
import SearchMinusIcon from '@coscom/coscom-ui/icons/searchminus';
import SearchPlusIcon from '@coscom/coscom-ui/icons/searchplus';
import TimesIcon from '@coscom/coscom-ui/icons/times';
import UndoIcon from '@coscom/coscom-ui/icons/undo';
import Portal from '@coscom/coscom-ui/portal';
import { DomHandler, ZIndexUtils } from '@coscom/coscom-ui/utils';
...
export default {
    ...
    methods: {
        ...
        onBeforeEnter() {
            ZIndexUtils.set('modal', this.mask, this.$coscom.config.zIndex.modal);
        },
        onEnter() {
            this.focus();
            this.$emit('show');
    ...
    computed: {
        ...
        rightAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.rotateRight : undefined;
        },
        leftAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.rotateLeft : undefined;
        },
        zoomInAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.zoomIn : undefined;
        },
        zoomOutAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.zoomOut : undefined;
        },
        zoomImageAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.zoomImage : undefined;
        },
        closeAriaLabel() {
