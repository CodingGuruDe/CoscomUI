...
import ThLargeIcon from '@coscom/coscom-ui/icons/thlarge';
...
export default {
    ...
    computed: {
        listViewAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.listView : undefined;
        },
        gridViewAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.gridView : undefined;
        }
    },
    components: {
        BarsIcon: BarsIcon,
