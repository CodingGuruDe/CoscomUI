...
export default {
    ...
    methods: {
        ...
        findNextHeaderAction(tabElement, selfCheck = false) {
            ...
            return headerElement
                ? DomHandler.getAttribute(headerElement, 'data-v-disabled') || DomHandler.getAttribute(headerElement, 'data-pc-section') === 'inkbar'
    ...
    computed: {
        ...
        prevButtonAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.previous : undefined;
        },
        nextButtonAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.next : undefined;
        }
    },
    directives: {
        ripple: Ripple
