...
export default {
    ...
    computed: {
        ...
        ariaValueLabel() {
            return this.modelValue ? this.$coscom.config.locale.aria.trueLabel : this.modelValue === false ? this.$coscom.config.locale.aria.falseLabel : this.$coscom.config.locale.aria.nullLabel;
        }
    },
    components: {
        CheckIcon,
