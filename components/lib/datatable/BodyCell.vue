...
import BarsIcon from '@coscom/coscom-ui/icons/bars';
...
import PencilIcon from '@coscom/coscom-ui/icons/pencil';
...
export default {
    ...
    computed: {
        ...
        expandButtonAriaLabel() {
            return this.$coscom.config.locale.aria ? (this.isRowExpanded ? this.$coscom.config.locale.aria.expandRow : this.$coscom.config.locale.aria.collapseRow) : undefined;
        },
        initButtonAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.editRow : undefined;
        },
        saveButtonAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.saveEdit : undefined;
        },
        cancelButtonAriaLabel() {
            return this.$coscom.config.locale.aria ? this.$coscom.config.locale.aria.cancelEdit : undefined;
        }
    },
    components: {
