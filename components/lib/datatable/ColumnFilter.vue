...
<script>
import { FilterOperator } from '@coscom/coscom-ui/api';
import BaseComponent from '@coscom/coscom-ui/basecomponent';
import Button from '@coscom/coscom-ui/button';
import Dropdown from '@coscom/coscom-ui/dropdown';
import FocusTrap from '@coscom/coscom-ui/focustrap';
import FilterIcon from '@coscom/coscom-ui/icons/filter';
import FilterSlashIcon from '@coscom/coscom-ui/icons/filterslash';
import PlusIcon from '@coscom/coscom-ui/icons/plus';
import TrashIcon from '@coscom/coscom-ui/icons/trash';
    ...
    computed: {
        ...
        matchModes() {
            return (
                ...
                this.$coscom.config.filterMatchModeOptions[this.type].map((key) => {
                    return { label: this.$coscom.config.locale[key], value: key };
                })
            );
        },
        isShowMatchModes() {
        ...
        operatorOptions() {
            return [
                { label: this.$coscom.config.locale.matchAll, value: FilterOperator.AND },
                { label: this.$coscom.config.locale.matchAny, value: FilterOperator.OR }
            ];
        },
        noFilterLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.noFilter : undefined;
        },
        isShowOperator() {
        ...
        removeRuleButtonLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.removeRule : undefined;
        },
        addRuleButtonLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.addRule : undefined;
        },
        isShowAddConstraint() {
            return this.showAddButton && this.filters[this.field].operator && this.fieldConstraints && this.fieldConstraints.length < this.maxConstraints;
        },
        clearButtonLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.clear : undefined;
        },
        applyButtonLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.apply : undefined;
        },
        filterMenuButtonAriaLabel() {
            return this.$coscom.config.locale ? (this.overlayVisible ? this.$coscom.config.locale.showFilterMenu : this.$coscom.config.locale.hideFilterMenu) : undefined;
        },
        filterOperatorAriaLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.filterOperator : undefined;
        },
        filterConstraintAriaLabel() {
            return this.$coscom.config.locale ? this.$coscom.config.locale.filterConstraint : undefined;
        },
