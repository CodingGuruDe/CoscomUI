...
const core_dependencies = {
    ...
    vite: '^4.0.0',
    Coscom: Coscom.version || 'latest',
    solidicons: app_dependencies['solidicons'] || 'latest'
};
...
const getVueApp = (props = {}, sourceType) => {
    ...
    if (deps !== null && component !== null) {
        imports += `import ${component} from 'coscom/${component.toLowerCase()}';
`;
...
`;
    ...
    if (embedded) {
        ...
        imports += `import Tailwind from 'coscom/passthrough/tailwind';
    ...
    const files = {
        'package.json': {
            content: {
                ...
                description: `**${description}** ${Coscom.description}`,
                keywords: [],
                scripts: {
                    dev: 'vite',
                    build: 'vite build',
...
import Button from 'coscom/button';
import ButtonGroup from 'coscom/buttongroup';
import Breadcrumb from 'coscom/breadcrumb';
import Calendar from 'coscom/calendar';
import Card from 'coscom/card';
import CascadeSelect from 'coscom/cascadeselect';
import Carousel from 'coscom/carousel';
import Checkbox from 'coscom/checkbox';
import Chip from 'coscom/chip';
import Chips from 'coscom/chips';
import ColorPicker from 'coscom/colorpicker';
import Column from 'coscom/column';
import ColumnGroup from 'coscom/columngroup';
import ConfirmDialog from 'coscom/confirmdialog';
import ConfirmPopup from 'coscom/confirmpopup';
import ConfirmationService from 'coscom/confirmationservice';
import ContextMenu from 'coscom/contextmenu';
import DataTable from 'coscom/datatable';
import DataView from 'coscom/dataview';
import DataViewLayoutOptions from 'coscom/dataviewlayoutoptions';
import DeferredContent from 'coscom/deferredcontent';
import Dialog from 'coscom/dialog';
import DialogService from 'coscom/dialogservice'
import Divider from 'coscom/divider';
import Dock from 'coscom/dock';
import Dropdown from 'coscom/dropdown';
import DynamicDialog from 'coscom/dynamicdialog';
import Fieldset from 'coscom/fieldset';
import FileUpload from 'coscom/fileupload';
import FloatLabel from 'coscom/floatlabel';
import FocusTrap from 'coscom/focustrap';
import Galleria from 'coscom/galleria';
import IconField from 'coscom/iconfield';
import InputIcon from 'coscom/inputicon';
import Image from 'coscom/image';
import InlineMessage from 'coscom/inlinemessage';
import Inplace from 'coscom/inplace';
import InputGroup from 'coscom/inputgroup';
import InputGroupAddon from 'coscom/inputgroupaddon';
import InputMask from 'coscom/inputmask';
import InputNumber from 'coscom/inputnumber';
import InputOtp from 'coscom/inputotp';
import InputSwitch from 'coscom/inputswitch';
import InputText from 'coscom/inputtext';
import Knob from 'coscom/knob';
import Listbox from 'coscom/listbox';
import MegaMenu from 'coscom/megamenu';
import Menu from 'coscom/menu';
import Menubar from 'coscom/menubar';
import Message from 'coscom/message';
import MeterGroup from 'coscom/metergroup';
import MultiSelect from 'coscom/multiselect';
import OrderList from 'coscom/orderlist';
import OrganizationChart from 'coscom/organizationchart';
import OverlayPanel from 'coscom/overlaypanel';
import Paginator from 'coscom/paginator';
import Panel from 'coscom/panel';
import PanelMenu from 'coscom/panelmenu';
import Password from 'coscom/password';
import PickList from 'coscom/picklist';
import ProgressBar from 'coscom/progressbar';
import ProgressSpinner from 'coscom/progressspinner';
import Rating from 'coscom/rating';
import RadioButton from 'coscom/radiobutton';
import Ripple from 'coscom/ripple';
import Row from 'coscom/row';
import SelectButton from 'coscom/selectbutton';
import ScrollPanel from 'coscom/scrollpanel';
import ScrollTop from 'coscom/scrolltop';
import Skeleton from 'coscom/skeleton';
import Slider from 'coscom/slider';
import Sidebar from 'coscom/sidebar';
import SpeedDial from 'coscom/speeddial';
import SplitButton from 'coscom/splitbutton';
import Splitter from 'coscom/splitter';
import SplitterPanel from 'coscom/splitterpanel';
import Stepper from 'coscom/stepper';
import StepperPanel from 'coscom/stepperpanel';
import Steps from 'coscom/steps';
import StyleClass from 'coscom/styleclass';
import TabMenu from 'coscom/tabmenu';
import TieredMenu from 'coscom/tieredmenu';
import Textarea from 'coscom/textarea';
import Toast from 'coscom/toast';
import ToastService from 'coscom/toastservice';
import Toolbar from 'coscom/toolbar';
import TabView from 'coscom/tabview';
import TabPanel from 'coscom/tabpanel';
import Tag from 'coscom/tag';
import Terminal from 'coscom/terminal';
import Timeline from 'coscom/timeline';
import ToggleButton from 'coscom/togglebutton';
import Tooltip from 'coscom/tooltip';
import Tree from 'coscom/tree';
import TreeSelect from 'coscom/treeselect';
import TreeTable from 'coscom/treetable';
import TriStateCheckbox from 'coscom/tristatecheckbox';
import VirtualScroller from 'coscom/virtualscroller';
${imports}

const app = createApp(App);

app.use(Coscom, { ripple: true ${unstyled} });
...
export default {
    ...
    content: [
        ...
        "./node_modules/coscom/**/*.{vue,js,ts,jsx,tsx}"
    ],
    theme: {
        extend: {}
    },
