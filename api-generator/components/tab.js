const TabProps = [
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Prev icon of the scrollable tab.'
    },
    {
        name: 'nextIcon',
        type: 'string',
        default: 'null',
        description: 'Next icon of the scrollable tab.'
    },
    {
        name: 'pt',
        type: 'any',
...
module.exports = {
    tab: {
        name: 'Tab',
        description: 'Tab is a container component to group content with tabs.',
        props: TabProps,
        event: TabEvents,
        slots: TabSlots
    }
