export const MachineService = {
        ...
        return [
            {
                id: '1000',
                code: 'f230fh0g3',
                name: 'Alzmetall GS 600',
                description: 'Miracle of Space',
                image: 'bamboo-watch.jpg',
                controlunit: 'Heidenhain TNC 640 (Standard)',
                category: 'Industry',
                quantity: 24,
            ...
            },
            {
                id: '1001',
                code: 'nvklal433',
                name: 'Alzmetall GS 1000',
                description: 'ALZMETALL-Specific-Gantry-Concept (ASGK)',
            ...
            },
            {
                ...
                description: 'Product Description',
                image: 'bracelet.jpg',
                controlunit: 'HEIDENHAIN iTNC 530',
                category: 'Industry',
                quantity: 73,
                inventoryStatus: 'INSTOCK',
                rating: 4
    ...
    getMachinesMini() {
        return Promise.resolve(this.getMachinesData().slice(0, 5));
    },

    getMachinesSmall() {
        return Promise.resolve(this.getMachinesData().slice(0, 10));
    },

    getMachines() {
        return Promise.resolve(this.getMachinesData());
    },

    getMachinesWithOrdersSmall() {
        return Promise.resolve(this.getMachinesWithOrdersData().slice(0, 10));
    },

    getMachinesWithOrders() {
        return Promise.resolve(this.getMachinesWithOrdersData());
    }
};
