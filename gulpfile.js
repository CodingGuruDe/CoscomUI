...
gulp.task('build-css', function () {
    return gulp.src(['./assets/styles/main.css']).pipe(concat('main.css')).pipe(gulp.dest('dist/resources')).pipe(rename('main.min.css')).pipe(gulp.dest('dist/resources'));
});
...
gulp.task('build-styles', gulp.series('build-themes', 'build-css'));
